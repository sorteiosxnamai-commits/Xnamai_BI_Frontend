...
function ProductDetail({
  ...
  return (
    <div className="retail-detail">
      ...
      <section className="retail-block">
        <h4>Breakdown financeiro (melhor canal)</h4>
        {!best && <p className="retail-empty">Sem breakdown.</p>}
        {best && (
          <dl className="retail-facts">
            ...
            <div>
              <dt>Preco tabela Mercos</dt>
              <dd>{money(product.listPrice)}</dd>
            </div>
            <div>
              <dt>Estoque</dt>
              <dd>{product.stock ?? "-"}</dd>
    ...
    <div className="page-stack retail-page">
      <section className="module-card retail-hero">
        ...
        <div className="retail-progress">
          <strong>
            {data?.analyzedCount ?? 0}/{data?.poolSize ?? 250} analisados
          </strong>
          <span>{data?.pendingCount ?? 0} pendentes no pool</span>
          <button
            type="button"
